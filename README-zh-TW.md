...
> **重要：** 版本 `1.3.2` 同步 `opencc-data` 1.3.2，包含新的上游 config 布局、segmentation 前 normalization，以及 CJK Compatibility Ideographs 映射。
...
```html
<script type="module">
  // 請使用 https://www.npmjs.com/package/opencc-js 上的最新 stable 版本，或明確固定 1.3.2
