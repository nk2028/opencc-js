...
> **重要：** 版本 `1.3.2-next.0` 包含一個關鍵 bugfix。如果你正在使用 CDN 或自行託管的建置檔案，請在下一個 stable release 發布前使用這個 prerelease。
...
```html
<script type="module">
  // 請使用 https://www.npmjs.com/package/opencc-js 上的最新 stable 版本，或使用 1.3.2-next.0 取得最新 bugfix
